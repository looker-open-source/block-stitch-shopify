include: "//@{CONFIG_PROJECT_NAME}/orders__line_items.view"

view: orders__line_items {
  extends: [orders__line_items_config]
}

view: orders__line_items_core {
  sql_table_name: @{SHOPIFY_SCHEMA_NAME}.orders__line_items ;;
